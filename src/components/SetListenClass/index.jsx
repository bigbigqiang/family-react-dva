...
@Form.create()
export default class SetListenClass extends Component {
    state = {
        typeTrue: true,
        uploading: false,
    ...
    handleOk = (e) => {
        ...
        const { listenclass: { sortDetails, targetPage } } = this.props;
